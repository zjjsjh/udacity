...
def conv_net(x, keep_prob):
    ...
    #layer = conv2d_maxpool(layer, conv_num_outputs[1], conv_ksize, conv_strides, pool_ksize, pool_strides)
    #layer = tf.nn.dropout(layer, keep_prob=keep_prob)
    #layer = conv2d_maxpool(layer, conv_num_outputs[2], conv_ksize, conv_strides, pool_ksize, pool_strides)
    #layer = tf.nn.dropout(layer, keep_prob=keep_prob)
    ...
    fully_layer = fully_conn(flatten_layer, 320)
    fully_layer = fully_conn(fully_layer, 160)
